...
* The original package name 'com.production.Recommendation Engine' is invalid and this project uses 'com.production.Recommendation.Engine' instead.
...
```
$ docker run --rm -p 8080:8080 Recommendation-Engine:0.0.1-SNAPSHOT
```
...
```
$ build/native-image/Recommendation-Engine
```
